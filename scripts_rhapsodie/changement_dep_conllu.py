...
def changer_head(liste_drafts_2, dico_correspondance):
    for draft, (cle, dico) in zip(liste_drafts_2, dico_correspondance.items()):
    ...
    for filename, sentences in zip(liste_filename, liste_drafts):
        ...
        with open(output_path, 'w', encoding='utf-8') as f:
            for sentence in sentences:
                ...
                f.write('\n\n')  # Separar las oraciones con una línea vacía
        print(f"Fichier exporté : {output_path}")

def main():
    corpus_1 = "/Users/maria23paz/Documents/Stage/Rhapsodie/Conllu_original_try1/"
    ...
    changer_head(drafts_finale, gran_dico)
